...
let
  ...
  configs = let
    ...
    filtered = lib.filterAttrs (n: v:
      n != "default.nix"
      && (v == "directory" || (v == "regular" && lib.hasSuffix ".nix" n)));
...
in {
  ...
  home.packages = with pkgs;
    [
      ...
      aria2 # curl/wget on steroid to download files using different protocols
      ...
      dust # du with a tree-like listing and usage graph
